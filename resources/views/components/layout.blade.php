              ...
              <form action="/login" method="POST" class="mb-0 pt-2 pt-md-0">
                  ...
                  <div class="row align-items-center">
                      <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
                          <input required name="loginusername" class="form-control form-control-sm input-dark" type="text" placeholder="Username" autocomplete="off" />
                          @error('loginusername')
                          <p class="m-0 small alert alert-danger shadow-sm">{{$message}}</p>
                          @enderror
                      </div>
                      <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
                          <input required name="loginpassword" class="form-control form-control-sm input-dark" type="password" placeholder="Password" />
                          @error('loginpassword')
                          <p class="m-0 small alert alert-danger shadow-sm">{{$message}}</p>
                          @enderror
                      </div>
